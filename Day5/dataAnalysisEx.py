...
fec.contbr_occupation = fec.contbr_ocupation.map(f)
print(fec.contbr_occupation.value_counts()[:10])
print()

by_occupation = fec.pivot_table('contb_receipt_amt',
                                index='contb_occupation',
                                columns='party',
                                aggfunc='sum')
...
# 구간을 나눔
bins = np.array[0, 1, 20, 100, 1000, 10000, 100000, 1000000, 10000000])
